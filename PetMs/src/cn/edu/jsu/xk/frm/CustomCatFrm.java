...
public class CustomCatFrm extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CustomCatFrm frame = new CustomCatFrm();
	 ...
	 * @throws SQLException 
	 */
	public CustomCatFrm() throws SQLException {
		...
		scrollPane.setBounds(34, 10, 958, 296);
		...
		btnNewButton.setBounds(425, 409, 108, 58);
		...
		btnNewButton_1.setBounds(278, 409, 100, 58);
		...
		btnNewButton_4.setBounds(619, 419, 52, 35);
